...
namespace WebComment.API.IServices
{
    public interface ICommentService
    {
        ...
        SearchCommentResultV2 SearchCommentV3(SearchCommentParamsV3 param, bool isReport = false);
        ...
        List<CM_UserLoginHistory> GetListLogInHistory(string MaNV, string ngayBatDau, string ngayKetThuc);
      ...
      string SearchEmployeeV2();
        ...
        List<CM_LichLamViec> GetLichLamViec(LichLamViec lichlamviec);
    }
}